...
use super::settings::PrintJobSettings;
...
pub struct PrintJob {
    ...
    status: PrintStatus,
    retry_count: u32,
    // TODO(1-N PrintJob): Change `pdf_url: String` to `documents: Vec<crate::domain::document::Document>`
    pub pdf_url: String,
    printer_name: String,
    created_at: i64,
...
impl PrintJob {
    ...
    // TODO(1-N PrintJob): Change `pdf_url` parameter to accept multiple documents
    pub fn new(pdf_url: String, printer_name: String, settings: PrintJobSettings) -> Self {
