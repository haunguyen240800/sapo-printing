//! TLS Infrastructure — local HTTPS server cert lifecycle.
//!
//! - `cert_generator`: sinh CA (10 năm) + server cert (397 ngày) bằng rcgen.
//! - `cert_checker`: check expiry, renewal status.
//! - `cert_installer` (Sprint 2): install CA vào system trust store.
