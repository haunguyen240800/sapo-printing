...
pub fn save_config(config: &PrintConfig) -> Result<(), String> {
...
pub fn load_config() -> Result<Option<PrintConfig>, String> {
    let config_path = get_config_file_path()?;
    ...
    let config: PrintConfig = serde_json::from_str(&json)
...
mod tests {
    ...
    fn test_deserialize_config() {
        ...
        let config: PrintConfig = serde_json::from_str(json).unwrap();
